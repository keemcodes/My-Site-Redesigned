...
async function addInitialProjects() {
  try {
    const initial911 = await models.Projects.create({
      date: 'Feb. 2023',
      title: 'Planning Platform Integration',
      body: 'Implemented an API to expose advertising inventory to third-party planning platforms, enhancing revenue potential through increased Request for Proposal (RFP) opportunities.',
      github: "https://github.com/keemcodes/",
      external: "https://github.com/keemcodes/",
      langs: [
        { lang: "JS" },
        { lang: "Node JS" },
      ]
    ...
    const initial91124 = await models.Projects.create({
      date: 'May 2022',
      title: 'Ad Leasing Latency',
      body: 'Built functionality to distribute advertisement playlists to network partners w/ load balancing. This feature directly contributes to the company-wide goal of decreasing latency between our systems and our fuel partners. Improvements decreased round-trip times from 10 hours to under an hour.',
      github: "https://github.com/keemcodes/",
      external: "https://github.com/keemcodes/",
      langs: [
        { lang: "JS" },
    ...
    const initial9112 = await models.Projects.create({
      date: 'May 2022',
      title: 'Real-Time Proof of Play',
      body: 'Deployed a lambda function to consume real-time proof of playback data from network partners. This data allows us to run analytics and adjust to maximize sales potential for advertising playlists. This was another overall improvement to latency between our microservices and network partners',
      github: "https://github.com/keemcodes/",
      external: "https://github.com/keemcodes/",
      langs: [
        { lang: "JS" },
    ...
    const initial91 = await models.Projects.create({
      date: 'Apr. 2022',
      title: 'Lottery API Integration',
      body: 'Worked on feature to integrate 3rd party APIs to display lottery jackpot information to our audience. Improving our overall ability to support different advertising options, creating more opportunities for revenue.',
      github: "https://github.com/keemcodes/",
      external: "https://github.com/keemcodes/",
      langs: [
        { lang: "JS" },
    ...
    const initial961 = await models.Projects.create({
      date: 'Mar. 2022',
      title: 'Automated Documentation',
      body: 'Designed a automated document generating pipeline to deliver scheduled documentation updates to a s3 html file container for view',
      github: "https://github.com/keemcodes/",
      external: "https://github.com/keemcodes/",
      langs: [
        { lang: "JS" },
...
module.exports.dbObject = { findProjects, findContacts, createContact, sync, dropTables, addInitialProjects, authenticate, forceSync }
